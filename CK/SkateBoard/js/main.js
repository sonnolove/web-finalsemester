...
function detailProduct(index) {
   ...
   <div class="modal-header">
        <img class="product-img" src="${infoProduct.img}" alt="">
    </div>
           ...
           <article class="card-product" >
               ...
               <div class="food-info">
                   ...
                   <div class="product-buy">
                       <button onclick="detailProduct(${product.id})" class="card-button order-item"><i class="fa-solid fa-cart-shopping-fast"></i> Đặt món</button>
                   </div> 
               </div>
               </div>
           </article>
...
// Find Product
var productAll = JSON.parse(localStorage.getItem('product')).filter(item => item.status == 1);
...
function searchProducts(mode) {
    ...
    switch (mode){
        case 0:
            result = JSON.parse(localStorage.getItem('product'));;
...
window.onload = showHomeProduct(JSON.parse(localStorage.getItem('product')))
